dragula([$('backlog'), $('tasks-progress'), $('progress-track'), $('tasks-done'), $('progress-progress'), $('progress-done'), $('done'), $('testing-done'), $('testing-processing')]);
////(function e(t, n, r) {
//    function s(o, u) {
//        if (!n[o]) {
//            if (!t[o]) {
...
//            dragula([$('backlog'), $('tasks-progress'), $('progress-track'), $('tasks-done'), $('progress-progress'), $('progress-done'), $('done'), $('testing-done'), $('testing-processing')]);
//            dragula([$('left-copy'), $('right-copy'), $('final-defaults')], {copy: true});
//            dragula([$('backlog'), $('tasks-progress'), $('tasks-done'), $('progress-progress'), $('progress-track'), $('progress-done'), $('testing-processing'), $('testing-done'), $('done')])
//                    .on('drag', function (el) {
...
//                        updateStickyMotion(el.parentElement.id, el.getAttribute("data-id"));
//                    });
